        ...
        <body> 
            ...
            <div className= "frontPageDiv">
              <h1 className='mainTitle'>
                Golfmatkat<br />hyvässä seurassa
              </h1>
              <h4 className='subTitle'>Koe upeat golfkohteet ympäri maailman!</h4>
                ...
                <Row>
                  <Col xs={12} sm={12} md={12} lg={4} >
                    <div className='destLinks'>
                      <h1 className='matkaHeader'>Costa Navarino</h1>
                  ...
                  <Col xs={12} sm={12} md={12} lg={4} >
                  <div className="destLinks">
                      <h1 className='matkaHeader'>Puerto Banus</h1> 
                  ...
                  <Col xs={12} sm={12} md={12} lg={4} >
                  <div  className="destLinks">
                    <h1 className='matkaHeader'>La Gomera</h1> 
        ...
        <h2 className="proHeader">
          ...
          <Row>
            <Col xs={12} sm={12} md={12} lg={4} >
              ...
              <h3 className="greenText" style={{fontWeight: 'bold'}}>GolfPro</h3>
            ...
            <Col xs={12} sm={12} md={12} lg={4} >
              ...
              <h3 className="greenText">GolfPro</h3>
